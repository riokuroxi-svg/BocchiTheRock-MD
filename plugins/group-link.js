...
var handler = async (m, { conn, args }) => {
    ...
    try {
        const pp = await conn.profilePictureUrl(group, 'image').catch((_) => 'https://raw.githubusercontent.com/Andresv27728/dtbs/main/Bocchi.jpg')
        ...
        let fallbackPP = await conn.profilePictureUrl(group, 'image').catch((_) => 'https://raw.githubusercontent.com/Andresv27728/dtbs/main/Bocchi.jpg')
