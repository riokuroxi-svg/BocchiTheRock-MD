...
const handler = async (m, { conn }) => {
  try {
    ...
    await conn.sendMessage(m.chat, { 
      text: "Estos son los creadores y desarrolladores más destacados en BocchiTheRock-MD si hay algún error o falla no olvides en reportarlo por alguno de nosotros (y nada de estar escribiendo a media noche por qué no te vamos a contestar)" 
    }, { quoted: m })
