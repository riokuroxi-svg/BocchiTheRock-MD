let handlerUnreg = async (m, { conn }) => {
  ...
  const pp = await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://raw.githubusercontent.com/Andresv27728/dtbs/main/Bocchi.jpg')
